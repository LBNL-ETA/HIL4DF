...
equation
  ...
  connect(temAirNor.T, multiplex3_1.u3[1]) annotation (Line(points={{313,290},{
          328,290},{328,304},{340,304},{340,341}}, color={0,0,127}));
  connect(temAirCor.T, multiplex3_1.u2[1]) annotation (Line(points={{315,228},{
          322,228},{322,248},{334,248},{334,348},{340,348}}, color={0,0,127}));
