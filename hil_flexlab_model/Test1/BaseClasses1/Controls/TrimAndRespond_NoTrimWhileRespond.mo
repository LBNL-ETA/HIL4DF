...
block TrimAndRespond_NoTrimWhileRespond
...
public
  ...
  Buildings.Controls.OBC.CDL.Reals.Add add2 "Net reset value"
    annotation (Placement(transformation(extent={{124,-112},{144,-92}})));
...
equation
  ...
  connect(triAmoCon.y, add2.u1)
    annotation (Line(points={{-178,-80},{112,-80},{112,-96},{122,-96}},
      color={0,0,127}));
  ...
  connect(swi3.y, add2.u2)
    annotation (Line(points={{142,-150},{150,-150},{150,-118},{114,-118},{114,
          -108},{122,-108}},color={0,0,127}));
  ...
  connect(greThr.y, switch.u2) annotation (Line(points={{42,-50},{116,-50},{116,
          -68},{126,-68}}, color={255,0,255}));
  connect(switch.y, netRes.u1)
    annotation (Line(points={{150,-68},{158,-68},{158,-38}}, color={0,0,127}));
  connect(swi3.y, switch.u1) annotation (Line(points={{142,-150},{166,-150},{
          166,-60},{126,-60}}, color={0,0,127}));
  connect(triAmoCon.y, switch.u3) annotation (Line(points={{-178,-80},{116,-80},
          {116,-76},{126,-76}}, color={0,0,127}));
annotation (
...
end TrimAndRespond_NoTrimWhileRespond;
