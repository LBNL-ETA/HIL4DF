...
block TrimAndRespond_DynamicLimits "Block to inplement trim and respond logic"
...
public
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant maxSetCon(k=maxSet)
    ...
    annotation (Placement(transformation(extent={{-182,68},{-162,88}})));
protected
...
public
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TOut(
    ...
    annotation (Placement(transformation(extent={{-262,116},{-222,156}}),
        iconTransformation(extent={{-140,20},{-100,60}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TOutMin(
    final unit="K",
    final displayUnit="degC",
    final quantity="ThermodynamicTemperature") annotation (Placement(
        transformation(extent={{-260,78},{-220,118}}), iconTransformation(
          extent={{-140,-8},{-100,32}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TSupSetMin(
    final unit="K",
    final displayUnit="degC",
    final quantity="ThermodynamicTemperature") annotation (Placement(
        transformation(extent={{-262,10},{-222,50}}), iconTransformation(extent
          ={{-140,-68},{-100,-28}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TOutMax(
    final unit="K",
    final displayUnit="degC",
    final quantity="ThermodynamicTemperature") annotation (Placement(
...
equation
  ...
  connect(TOut, lin.u) annotation (Line(points={{-242,136},{-122,136},{-122,66},
          {-104,66}}, color={0,0,127}));
  connect(TOutMin, lin.x1) annotation (Line(points={{-240,98},{-114,98},{-114,
          74},{-104,74}}, color={0,0,127}));
  connect(TOutMax, lin.x2) annotation (Line(points={{-240,60},{-112,60},{-112,
          62},{-104,62}}, color={0,0,127}));
  connect(TSupSetMin, lin.f2) annotation (Line(points={{-242,30},{-112,30},{
          -112,58},{-104,58}}, color={0,0,127}));
  connect(maxSetCon.y, lin.f1) annotation (Line(points={{-160,78},{-118,78},{
...
end TrimAndRespond_DynamicLimits;
