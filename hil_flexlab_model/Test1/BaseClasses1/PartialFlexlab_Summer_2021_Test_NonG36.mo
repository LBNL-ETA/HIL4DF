...
partial model PartialFlexlab_Summer_2021_Test_NonG36
  ...
  //parameter Modelica.Units.SI.MassFlowRate mPle_flow_nominal=0.1133
...
equation
  ...
  connect(dpRetDuc.port_a, splRetNor.port_1) annotation (Line(points={{400,140},
          {672,140},{672,112},{760,112},{760,24},{752,24},{752,0},{764,0}},
        color={0,127,255}));
...
end PartialFlexlab_Summer_2021_Test_NonG36;
