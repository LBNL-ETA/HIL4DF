...
model ZoneAirTemperatureCalibration1A
  ...
  Modelica.Blocks.Sources.CombiTimeTable norFloTab(
    tableOnFile=true,
    tableName="tab1",
    fileName="/home/huangwp/LBNL_work/HIL/convert_csv_to_txt/txt_files/1A_VAV_North_Zone_Airflow_Rate.txt",
  ...
  Modelica.Blocks.Sources.CombiTimeTable corFloTab(
    tableOnFile=true,
    tableName="tab1",
    fileName="/home/huangwp/LBNL_work/HIL/convert_csv_to_txt/txt_files/1A_VAV_Core_Zone_Airflow_Rate.txt",
    smoothness=Modelica.Blocks.Types.Smoothness.LinearSegments,
    extrapolation=Modelica.Blocks.Types.Extrapolation.HoldLastPoint)
  ...
  Modelica.Blocks.Sources.CombiTimeTable souFloTab(
    tableOnFile=true,
    tableName="tab1",
    fileName="/home/huangwp/LBNL_work/HIL/convert_csv_to_txt/txt_files/1A_VAV_South_Zone_Airflow_Rate.txt",
    smoothness=Modelica.Blocks.Types.Smoothness.LinearSegments,
    extrapolation=Modelica.Blocks.Types.Extrapolation.HoldLastPoint)
  ...
  Modelica.Blocks.Sources.CombiTimeTable norRooTem(
    tableOnFile=true,
    tableName="tab1",
    fileName="/home/huangwp/LBNL_work/HIL/convert_csv_to_txt/txt_files/1A_VAV_North_Zone_Room_Air_Temperature.txt",
    smoothness=Modelica.Blocks.Types.Smoothness.LinearSegments,
    extrapolation=Modelica.Blocks.Types.Extrapolation.HoldLastPoint)
  ...
  Modelica.Blocks.Sources.CombiTimeTable corRooTem(
    tableOnFile=true,
    tableName="tab1",
    fileName="/home/huangwp/LBNL_work/HIL/convert_csv_to_txt/txt_files/1A_VAV_Core_Zone_Room_Air_Temperature.txt",
    smoothness=Modelica.Blocks.Types.Smoothness.LinearSegments,
    extrapolation=Modelica.Blocks.Types.Extrapolation.HoldLastPoint)
  ...
  Modelica.Blocks.Sources.CombiTimeTable souRooTem(
    tableOnFile=true,
    tableName="tab1",
    fileName="/home/huangwp/LBNL_work/HIL/convert_csv_to_txt/txt_files/1A_VAV_South_Zone_Room_Air_Temperature.txt",
    smoothness=Modelica.Blocks.Types.Smoothness.LinearSegments,
    extrapolation=Modelica.Blocks.Types.Extrapolation.HoldLastPoint)
  ...
  Modelica.Blocks.Sources.CombiTimeTable OAT(
    tableOnFile=true,
    tableName="tab1",
    fileName="/home/huangwp/LBNL_work/HIL/convert_csv_to_txt/txt_files/1A_Outdoor_Air_Temperature.txt",
    smoothness=Modelica.Blocks.Types.Smoothness.LinearSegments,
    extrapolation=Modelica.Blocks.Types.Extrapolation.HoldLastPoint)
...
end ZoneAirTemperatureCalibration1A;
